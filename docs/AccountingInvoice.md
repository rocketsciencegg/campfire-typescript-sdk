...
**lines** | [**Array&lt;AccountingInvoiceLine&gt;**](AccountingInvoiceLine.md) |  | [default to undefined]
**emails** | **Array&lt;{ [key: string]: any; }&gt;** |  | [readonly] [default to undefined]
**payments** | [**Array&lt;AccountingInvoicePayment&gt;**](AccountingInvoicePayment.md) |  | [readonly] [default to undefined]
...
```typescript
import { AccountingInvoice } from 'campfire-typescript-sdk';

const instance: AccountingInvoice = {
    id,
    lines,
    emails,
    payments,
