...
**uncategorizedNameAndNumber** | **string** |  | [optional] [readonly] [default to undefined]
**accountsPayableNameAndNumber** | **string** |  | [optional] [readonly] [default to undefined]
**accountsReceivableNameAndNumber** | **string** |  | [optional] [readonly] [default to undefined]
**deferredRevenueNameAndNumber** | **string** |  | [optional] [readonly] [default to undefined]
**accruedRevenueNameAndNumber** | **string** |  | [optional] [readonly] [default to undefined]
**unrealizedGainLossNameAndNumber** | **string** |  | [optional] [readonly] [default to undefined]
**realizedGainLossNameAndNumber** | **string** |  | [optional] [readonly] [default to undefined]
**roundingAccountNameAndNumber** | **string** |  | [optional] [readonly] [default to undefined]
**unappliedCreditsNameAndNumber** | **string** |  | [optional] [readonly] [default to undefined]
**unappliedDebitsNameAndNumber** | **string** |  | [optional] [readonly] [default to undefined]
**unbilledRevenueNameAndNumber** | **string** |  | [optional] [readonly] [default to undefined]
**defaultClearingNameAndNumber** | **string** |  | [optional] [readonly] [default to undefined]
**discountAccountNameAndNumber** | **string** |  | [optional] [readonly] [default to undefined]
**refundAccountNameAndNumber** | **string** |  | [optional] [readonly] [default to undefined]
**processingFeesNameAndNumber** | **string** |  | [optional] [readonly] [default to undefined]
**deferredProcessingFeesNameAndNumber** | **string** |  | [optional] [readonly] [default to undefined]
**taxAccountNameAndNumber** | **string** |  | [optional] [readonly] [default to undefined]
**payoutAccountNameAndNumber** | **string** |  | [optional] [readonly] [default to undefined]
**ctaAccountNameAndNumber** | **string** |  | [optional] [readonly] [default to undefined]
**fixedAssetDisposalNameAndNumber** | **string** |  | [optional] [readonly] [default to undefined]
...
```typescript
import { PatchedChartAccountSettings } from 'campfire-typescript-sdk';

const instance: PatchedChartAccountSettings = {
    id,
