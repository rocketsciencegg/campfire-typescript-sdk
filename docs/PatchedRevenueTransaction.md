...
**productIsTaxable** | **boolean** |  | [optional] [readonly] [default to undefined]
**contractIdentifier** | **string** |  | [optional] [readonly] [default to undefined]
**clientIdentifier** | **string** |  | [optional] [readonly] [default to undefined]
**productIdentifier** | **string** |  | [optional] [readonly] [default to undefined]
**grossAmount** | **string** |  | [optional] [readonly] [default to undefined]
**invoiceNumber** | **string** |  | [optional] [readonly] [default to undefined]
**invoiceDate** | **string** |  | [optional] [readonly] [default to undefined]
**invoicePaymentStatus** | **string** |  | [optional] [readonly] [default to undefined]
**invoiceVoidedDate** | **string** |  | [optional] [readonly] [default to undefined]
**revenueType** | **string** |  | [optional] [readonly] [default to undefined]
**journalEntryOrder** | **string** |  | [optional] [readonly] [default to undefined]
**contractSubscriptionNotes** | **string** |  | [optional] [readonly] [default to undefined]
...
**usageTierName** | **string** |  | [optional] [readonly] [default to undefined]
**lastModifiedAt** | **string** |  | [optional] [readonly] [default to undefined]
**anrokItemId** | **string** |  | [optional] [readonly] [default to undefined]
**sphereItemId** | **string** |  | [optional] [readonly] [default to undefined]
...
```typescript
import { PatchedRevenueTransaction } from 'campfire-typescript-sdk';

const instance: PatchedRevenueTransaction = {
    id,
    isDeleted,
    deletedAt,
    entityName,
